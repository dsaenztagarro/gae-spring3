...
<meta name="menu" content="register-page1" /> 
...
<body id="yaml-top" class="doc" data-twttr-rendered="true">
	...
	<div class="ym-wrapper">
		<div class="ym-wbox">
			...
			<div class="ym-gbox">
				<h3><spring:message code="pet.wizard.page1" /></h3>
			</div>
			<div class="ym-grid">
					...
					<div class="ym-gbox">
						...
						<form:form method="POST" commandName="registerWizardForm"
							...
							<div class="ym-grid linearize-level-1">
								<div class="ym-g50 ym-gl">
									<div class="ym-fbox-text">
										...
										<form:input path="pet.name" id="name" type="text" size="20" />
									</div>
								</div>
							...
							<div class="ym-fbox-button">	
								<input type="submit" class=submit name="_target1" value='<spring:message code="next" />' >
				...
				<div class="ym-g40 ym-gr">
					<div class="ym-gbox">
						<yaml:img src="register_wizard_page1.jpg"></yaml:img>
					</div>
				</div>
			</div>
